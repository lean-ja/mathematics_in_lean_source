...
OMIT. -/
/- TEXT:
既におわかりかもしれませんがこの命題において，全称量化子が対象を束縛，含意の矢印が仮説を導入，とそれぞれ異なることをしているにもかかわらず，Leanはこの2つを非常に似た方法で扱っています．特に，このような構造の定理を証明した場合，その定理をモノにもコトにも同じように適用することができます．この事の例として，少しあとで証明する以下の命題を用いましょう:
TEXT. -/
-- QUOTE:
